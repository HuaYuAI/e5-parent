  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>${user.username}&nbsp;&nbsp;&nbsp;&nbsp;${user.phone}&nbsp;&nbsp;&nbsp;&nbsp;北京市&nbsp;&nbsp;昌平区&nbsp;&nbsp;北七家镇 修正大厦</li>
          </ul>
        </div>
    </div>
  </div>
			...
			<div class="orderTbl">
				...
				<div class="orderPInfo">
					...
					<div class="pItem pGoods">
						<a href="http://localhost:8081/item/${cart.id}.html" target="_blank">${cart.title }</a>
					</div>
					...
					<div class="pItem pQuantity">${cart.number}</div>
					<div class="pItem pWeight">0.72kg</div>
					<div class="pItem pSubtotal">¥${cart.price / 100 * cart.number}</div>
					<span class="clear"></span>
				</div>
				</c:forEach>
